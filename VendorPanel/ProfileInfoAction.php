...
if(isset($_POST['readRecord']))
{
     $data = ' <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <tr>
          ...
          <th class="" scope="col">Profile Photo</th>
          ...
          <th class="" scope="col" style="color:#1BBAE1;">Edit</th>
           <th class="" scope="col" style="color:#1BBAE1;">Delete</th>
             ...
             $query = "SELECT * FROM `vendor_info` WHERE email ='".$_POST['hidden']."'";
                      ...
                      $data .= '<tr>
                          ...
                          <td>' .$row['phone']. '</td>
                               ...
                               <td>
                                       ...
                                       <img src="'.$row['profile_photo'].'" height="60" width="75" class="img-thumbnail" />
